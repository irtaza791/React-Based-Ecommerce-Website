...
const avatars = [
  'https://avatars.dicebear.com/v2/male/33c183ba71f93300a5be52ae313cb2fb.svg',
  'https://avatars.dicebear.com/v2/female/33c183ba71f93300a5be52ae313cb2fb.svg',
...
/>
      ...
      <Box sx={{ m: 3 }}>
       <Button variant="contained" color="primary" onClick={() => {setIsEditMode(true); setNewUserInfo(userData)}}>
  Edit Profile
</Button>
      </Box>
    )}
